...
"""
    print(banner)
    print(f"\033[1;37m[WEB UI]\033[0m \033[38;5;82mRunning locally at {FIX_API_BASE}/\033[0m")
    print(f"\033[1;37m[REPORT]\033[0m \033[38;5;244mSaved to {output_path}\033[0m")
    print("\033[38;5;244m(Press Ctrl+C to stop the server)\033[0m\n")
    try:
        while True:
